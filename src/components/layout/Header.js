            ...
            <div className='max-w-screen-2xl sticky top-0 z-50 bg-white mx-auto flex items-center justify-between p-4'>
                ...
                <div className='flex items-center gap-3'>
                    ...
                    <div onClick={()=>open()} className='cursor-pointer relative'>
                        <span className='w-4 h-4 flex justify-center items-center text-[10px] font-medium absolute -right-1 top-3 rounded-full bg-[#10069f] text-white'>{cart.length}</span>
