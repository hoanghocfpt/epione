                            ...
                            <tr className='py-[16px] grid gap-[16px] grid-rows-[auto_auto] grid-cols-[80px_1fr_1fr] border-b border-[#e5e5e5] last-of-type:border-none'>
                                <td className='row-start-1 row-end-3'>
                                    <Link href='#' className='flex gap-4'>
                                        <Image width={150} height={113} className='' src='/ban-nang-ha-epione-smartdesk-lite-20-110457.webp' alt='product' />
                                    </Link>
                                </td>
                                <td className='col-start-2 col-end-4'>
                                    <div className='flex items-center justify-between'>
                                        <a href='#' className='flex gap-4'>
                                            <span className='text-sm text-[#282828] font-bold'>Ghế công thái học Epione ElysChair</span>
                                        </a>
                                    ...
                                    <span className='text-xs text-[#929292]'>Không kê đầu / Cool Gray</span>
                                </td>
                                <td>
                                ...
                                <td className='text-right'>
                                    <span className='text-[#10069f] text-lg font-bold'>2.690.000₫</span>
                                </td>
                            </tr>
                            <tr className='py-[16px] grid gap-[16px] grid-rows-[auto_auto] grid-cols-[80px_1fr_1fr] border-b border-[#e5e5e5] last-of-type:border-none'>
                                <td className='row-start-1 row-end-3'>
