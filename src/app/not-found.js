    ...
    return (
        <div>
            <div className='flex items-center py-[8px] max-w-screen-2xl mx-auto px-8 bg-[#f0f0f0]'>
                ...
                <span className='text-xs text-[#282828]'>404 Không tìm thấy</span>
            </div>
            <div className='w-[480px] mx-auto mt-24 flex flex-col items-center'>
                ...
                <Link href={'/'} className='bg-[#10069f] text-white h-[46px] leading-none flex justify-center items-center px-[24px] rounded-xl mt-[24px]'>Về trang chủ</Link>
            </div>
        </div>
    )
}
