                ...
                <div className='pl-7 py-3'>
                    ...
                    <div className='border flex items-center gap-2 rounded-lg'>
                        <div className='w-full h-[44px] border border-[#10069f] rounded-lg flex justify-center items-center cursor-pointer'>
                            <span className='font-bold text-[#10069f]'>Mua lẻ</span>
                        </div>
                        <div className='w-full h-[44px] border border-transparent rounded-lg flex justify-center items-center cursor-pointer  flex-col'>
                            <span className='font-bold'>Mua sỉ</span>
                    ...
                    <div className='flex flex-col gap-5 mt-5'>
                        ...
                        <div className='flex items-center gap-3'>
                            ...
                            <button className='w-full outline h-[42px] hover:outline-[#10069f] outline-transparent bg-[#10069f] text-white rounded-lg flex justify-center items-center cursor-pointer'>
                                <span className='font-medium text-lg'>Thêm vào giỏ hàng</span>
